...
//   const recentLeads = [
//     { name: "John Smith", company: "Tech Corp", status: "important", value: "$15,000" },
//     { name: "Sarah Wilson", company: "Marketing Inc", status: "important", value: "$8,500" },
//     { name: "Mike Johnson", company: "Sales Pro", status: "important", value: "$12,000" },
//     { name: "Emma Davis", company: "Design Co", status: "important", value: "$9,500" },
//   ];

//   const getStatusColor = (status) => {
//     const colors = {

//       'important': 'bg-red-300 text-black-800'
//     };
//     return colors[status] || 'bg-gray-100 text-black-800';
//   };
...
//                     <h3 className="text-lg leading-6 font-medium text-gray-900">All important Leads :</h3>
//                   </div>
...
const Important = () => {
  ...
  const getStatusColor = (status) => {
    const colors = {
      ...
      'Important': 'bg-green-100 text-red-800'
    };
        ...
        <div className=' flex'>
          ...
          <div className="min-h-screen  m-2 w-[100%] ">
            <div className="hometop  h-[10%] flex items-center bg-gray-300 justify-between">
              <div className="heading text-3xl font-bold text-blue-600 ml-4">Important Leads</div>
            </div>
            <div className="overflow-x-auto">
